...
class JobSource(TimeStampedModel):
    SOURCE_TYPE_CHOICES = [
        ...
        ("BUMERAN", "Bumeran"),
        ("INDEED", "Indeed"),
        ("COMPANY_SITE", "Pagina corporativa"),
        ("OTHER", "Otro"),
    ]
...
class AIRequestLog(TimeStampedModel):
    TASK_TYPE_CHOICES = [
        ...
        ("CV_GENERATION", "Generacion de CV"),
        ("SALARY_RECOMMENDATION", "Recomendacion salarial"),
        ("APPLICATION_ANSWER", "Respuesta de postulacion"),
        ("INTERVIEW_PREP", "Preparacion de entrevista"),
        ("OTHER", "Otro"),
    ]
